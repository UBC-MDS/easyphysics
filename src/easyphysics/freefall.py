...
def freefall(height, g = 9.8):
    """ A function calculates the distance traveled by a falling object 
    using the equation of motion h = 1/2*gt^2, returns the time it takes for the free fall, 
    and a plot compares the time it takes for the free fall on different planets.
